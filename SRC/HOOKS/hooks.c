...
/*   Updated: 2023/09/07 00:26:24 by jareste-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	aux_rot_left(t_game *game, float olddirx, float oldplanex)
{
...
void	aux_rot_right(t_game *game, float olddirx, float oldplanex)
{
	game->player.dirx = game->player.dirx * cos(-TURN) - \
	game->player.diry * sin(-TURN);
	game->player.diry = olddirx * sin(-TURN) + \
